...
function maybeEvaluator(name, reduce, inputs, asReduce = maybeReduce) {
  ...
  return {
    ...
    reduce(I2, extent2) {
      return reducer2.scope == null ? reducer2.reduceIndex(I2, V2, extent2) : reducer2.reduceIndex(I2, V2, context, extent2);
    }
  };
}
...
function PlotEditor(props) {
  ...
  console.debug("PlotEditor", props.initalMarks, marks2);
  if (!show) {
